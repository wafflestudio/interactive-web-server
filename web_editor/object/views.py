...
class ObjectViewSet(GenericViewSet):
    ...
    def list(self, request):
        ...
        return Response(status=status.HTTP_200_OK, data=self.get_serializer(instances, many=True).data)
    ...
    def partial_update(self, request, pk=None):
        ...
        if request.data.get('project_name', None) is not None:
    ...
    def destroy(self, request, pk=None):
        ...
        instance.delete()
        return Response(status=status.HTTP_200_OK, data={"success": True, "object": self.get_serializer(instance).data})
